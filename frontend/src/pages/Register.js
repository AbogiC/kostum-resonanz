    ...
    <div className="min-h-screen bg-[#02040a]">
      ...
      <div className="min-h-screen flex items-center justify-center px-6 pt-20">
        <div className="glass-card rounded-sm max-w-md w-full p-8 md:p-12">
          <h1 className="font-serif text-4xl md:text-5xl font-normal text-white mb-2" data-testid="register-title">
            Join Us
          </h1>
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            <div>
              <label className="block text-white/70 mb-2" htmlFor="name">Name</label>
              <input
                id="name"
                type="text"
                value={name}
